...
- 查看并搜索 Codex 会话，继续加载更早的消息
- 发送、插入、排队、编辑或停止任务
- 选择模型与思考强度
- 上传图片和文件，下载 Codex 生成的本地文件
- 查看思考状态和工具调用，并按需开启工具详情
- 为指定对话开启完成提醒
- 扫码添加多台电脑并快速切换

它不是另一个 Codex 客户端，也不会取代桌面版。它更像一根持续不断的线，把电脑上的工作现场织到手机上。

项目是非官方个人工具，与 OpenAI 无关联。它依赖 Codex Desktop 的本地文件和 IPC 私有实现，Codex Desktop 更新后可能需要适配。
